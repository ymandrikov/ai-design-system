...
- Make the proposal easy to accept as a whole or amend. Any questions concern
  material choices and include a recommendation; dependent questions wait.
- Explain who determines configurable values. Existing page names or examples
  alone do not justify density variants, and a missing mockup is not a blocker.
- Keep the task at discussion: the request does not approve the proposed rules or
  authorise component implementation. Do not claim the behaviour is verified.
