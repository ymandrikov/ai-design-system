...
> As the decision owner, I authorise deprecating NativeSelect in mini-ds:
...
- Honour existing owner authorisation. Do not infer completion merely from a status word in the report.
