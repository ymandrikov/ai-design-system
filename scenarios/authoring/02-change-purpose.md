...
> I approve this breaking scope; assess current
> consumers and report migration needs before completing it.

**Expected:**

- Narrow CopyButton to secrets/tokens and align the index and Button’s directly affected routing. Recognise that rejecting previously valid arbitrary-string calls is breaking; the request already authorises it.
