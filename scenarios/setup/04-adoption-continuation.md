...
- Preserve the saved admission conditions and whole-set discovery timing on resume.
  Do not reconstruct connection history or consult setup to interpret them.
...
- Admit fully documented existing items before the final whole-set independent gate.
  Keep unsupported or incomplete items hidden and unfinished. Do not run per-batch
  independent gates or equate analysis completion with admission.
