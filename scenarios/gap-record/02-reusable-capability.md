...
> Discovery returned `Candidates: none` and `Choice: nothing fits` for an
> inline warning banner about expired API tokens. The same warning pattern is
> already needed in several settings areas. Record the gap.
