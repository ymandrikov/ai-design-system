...
Use Autocomplete when all of these hold:
...
shows the list in a popup layered over the content after it. Arrow Down and Arrow Up move the highlighted option,
