...
and return the missing inputs to the calling workflow for recovery or clarification.
Discovery itself does not write files; resume it once required context is available.
