...
that caller. Read [contract formats](formats.md), DESIGN.md
...
Audit ready changes during authoring. Reuse actual implementation, consumer and
contract check results under the [final reconciliation rule](completion.md#reconcile-final-results),
checking only missing or invalidated evidence when this procedure is called again.
